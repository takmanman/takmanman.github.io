...
each kernel in the convolution layer produces an output of size \(7 \times 7\), and there are 32 such kernels which together product a volume of \(32 \times 7 \times 7\).
